...
CREATE  TABLE OTC_MARKET_ANALYSIS.DIM_GICS ( 
	...
	CONSTRAINT PK_DIM_GICS PRIMARY KEY ( GICS_ID )
 );
...
CREATE  TABLE OTC_MARKET_ANALYSIS.DIM_SOURCE ( 
	...
	BEST_BID_SOURCE      varchar(100)    ,
	BEST_ASK_SOURCE      varchar(100)    ,
...
CREATE  TABLE OTC_MARKET_ANALYSIS.FACT_OTC_TRANSACTIONS ( 
	...
	SECURITY_ID          integer NOT NULL   ,
	GICS_ID              integer NOT NULL   ,
	CLOSING_INSIDE_BID_PRICE_DATE_ID date NOT NULL   ,
	CLOSING_INSIDE_ASK_PRICE_DATE_ID date NOT NULL   ,
	PREVIOUS_CLOSE_DATE_ID date NOT NULL   ,
	SHORT_INTEREST_DATE  date NOT NULL   ,
	CLOSING_BEST_BID_DATE_ID date NOT NULL   ,
	CLOSING_BEST_ASK_DATE_ID date NOT NULL   ,
...
ALTER TABLE OTC_MARKET_ANALYSIS.FACT_OTC_TRANSACTIONS ADD CONSTRAINT FK_FACT_OTC_TRANSACTIONS_DIM_GICS FOREIGN KEY ( GICS_ID ) REFERENCES OTC_MARKET_ANALYSIS.DIM_GICS( GICS_ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE OTC_MARKET_ANALYSIS.FACT_OTC_TRANSACTIONS ADD CONSTRAINT FK_FACT_OTC_TRANSACTIONS_DIM_DATE FOREIGN KEY ( CLOSING_INSIDE_BID_PRICE_DATE_ID ) REFERENCES OTC_MARKET_ANALYSIS.DIM_DATE( DATE_ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE OTC_MARKET_ANALYSIS.FACT_OTC_TRANSACTIONS ADD CONSTRAINT FK_FACT_OTC_TRANSACTIONS_DIM_DATE_0 FOREIGN KEY ( CLOSING_INSIDE_ASK_PRICE_DATE_ID ) REFERENCES OTC_MARKET_ANALYSIS.DIM_DATE( DATE_ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE OTC_MARKET_ANALYSIS.FACT_OTC_TRANSACTIONS ADD CONSTRAINT FK_FACT_OTC_TRANSACTIONS_DIM_DATE_1 FOREIGN KEY ( PREVIOUS_CLOSE_DATE_ID ) REFERENCES OTC_MARKET_ANALYSIS.DIM_DATE( DATE_ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE OTC_MARKET_ANALYSIS.FACT_OTC_TRANSACTIONS ADD CONSTRAINT FK_FACT_OTC_TRANSACTIONS_DIM_DATE_3 FOREIGN KEY ( CLOSING_BEST_BID_DATE_ID ) REFERENCES OTC_MARKET_ANALYSIS.DIM_DATE( DATE_ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE OTC_MARKET_ANALYSIS.FACT_OTC_TRANSACTIONS ADD CONSTRAINT FK_FACT_OTC_TRANSACTIONS_DIM_DATE_4 FOREIGN KEY ( CLOSING_BEST_ASK_DATE_ID ) REFERENCES OTC_MARKET_ANALYSIS.DIM_DATE( DATE_ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;
